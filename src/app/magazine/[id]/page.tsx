    ...
    if (!res.success || !res.magazine) {
        return (
            <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
                <div className="w-20 h-20 bg-gray-50 rounded-3xl flex items-center justify-center mb-8 text-gray-400">
                    <Clock className="w-10 h-10" />
                </div>
                <h1 className="text-3xl font-black tracking-tighter mb-4 text-black">기사를 찾을 수 없습니다</h1>
                <Link href="/magazine" className="text-gray-600 hover:text-black transition-colors font-bold text-xs uppercase tracking-widest border-b border-transparent hover:border-black pb-1">
                    Back to Magazine
                </Link>
            </div>
        );
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 px-6 lg:px-12 py-8 flex justify-between items-center bg-white/80 backdrop-blur-md border-b border-gray-50">
                <Link href="/magazine" className="flex items-center gap-2 text-gray-600 hover:text-black transition-all font-black text-[10px] tracking-widest uppercase group">
                    <ChevronLeft className="w-4 h-4 transition-transform group-hover:-translate-x-1" /> Back to Magazine
                </Link>
                <div className="flex gap-8 text-[10px] font-black tracking-widest uppercase text-gray-500">
            ...
            <header className="pt-48 pb-24 px-6 lg:px-12">
                <div className="max-w-4xl mx-auto">
                    <div className="flex flex-col items-center text-center space-y-8">
                        ...
                        <div className="flex items-center justify-center gap-12 text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 border-y border-gray-50 py-8 w-full animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-400">
            ...
            <article className="max-w-4xl mx-auto px-6 py-40">
                ...
                <div className="mt-32 pt-20 border-t border-gray-50 flex flex-col items-center gap-12 text-center">
                    <div className="space-y-4">
                        <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em]">Enjoyed this story?</p>
                        <ShareButton title={magazine.title} />
                    </div>
                    <Link
                        href="/magazine"
                        className="text-gray-600 hover:text-black transition-colors font-black text-[10px] uppercase tracking-widest border-b border-transparent hover:border-black pb-1"
                    >
                        More Stories
                    </Link>
                </div>
