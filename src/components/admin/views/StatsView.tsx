...
const StatCard = ({ title, value, icon: Icon, unit = "", color, onClick }: any) => (
    ...
    >
        ...
        <div className="flex items-start justify-between mb-6">
            ...
            <ArrowUpRight className="w-5 h-5 text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity" />
        </div>
        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-10 rounded-[40px] border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-gray-600 mt-3 font-medium text-sm">현재 플랫폼은 안정적으로 운영되고 있습니다. <br className="hidden md:block" /> 오늘 처리해야 할 업무를 확인해 보세요.</p>
                </div>

                <div className="relative z-10 flex flex-col items-end gap-3">
                    <div className="flex gap-2">
                        <div className="px-4 py-2 bg-gray-50 rounded-full border border-gray-100 text-[10px] font-bold text-gray-700 uppercase tracking-widest">Server Status: Online</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-[40px] border border-gray-100 p-10 shadow-sm space-y-8">
                    <div className="flex items-center justify-between">
                        ...
                        <button className="text-[10px] font-bold text-gray-600 hover:text-black transition-colors uppercase tracking-widest">View All</button>
                    </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center justify-between py-4 border-b border-gray-50 last:border-0 group cursor-pointer hover:bg-gray-50/50 px-4 -mx-4 rounded-2xl transition-all">
                                <div className="flex items-center gap-6">
                                    <div className="w-12 h-12 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-600 group-hover:bg-black group-hover:text-white transition-all">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] text-gray-600 mt-1 font-medium italic">Just {i * 10} minutes ago</p>
                                    </div>
                                </div>
                ...
                <div className="flex flex-col gap-8">
                    <div className="bg-black rounded-[40px] p-8 text-white relative overflow-hidden group h-full">
                        ...
                        <p className="text-gray-600 text-xs mb-6 z-10 relative leading-relaxed">
                    ...
                    <div className="bg-gray-50 rounded-[40px] p-8 border border-gray-100 flex flex-col justify-center text-center">
                        <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest mb-2">Growth Rate</p>
